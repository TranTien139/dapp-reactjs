...
export const web3Connect = () => async (dispatch) => {
  ...
  if (web3.currentProvider.connection.networkVersion !== '97') {
    alert('Unknown network, please change network to testnet network');
    return;
  }
...
export const instantiateContracts = () => async (dispatch, getState) => {
  ...
  let web3 = state.web3;
  const networkId = process.env.REACT_APP_NETWORK_ID || 97;
